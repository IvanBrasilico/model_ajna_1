"""Exporta imagens com NCM único (4 posições) para diretorio

Extrai imagens para diretorio "Posição NCM" de acordo com a marcação
na base de dados.
...
Options:
  ...
  --limit INTEGER  Limite de registros total - padrão 1000
  --limit INTEGER  Limite de registros por NCM (balanceamento) - padrão 10
...
MIN_RATIO = 1.8 # Elimina imagens malformadas/deformadas na origem
